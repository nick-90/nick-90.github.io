        ...
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    ...
                    <li><a data-toggle="dropdown" class="dropdown-toggle" href="/about">About</a> </li>
                    <li><a data-toggle="dropdown" class="dropdown-toggle" href="/contact">Contact</a> </li>
                    <?php if (!Yii::$app->user->isGuest):?><li><a data-toggle="dropdown" class="dropdown-toggle" href="/admin">Admin</a> </li><? endif;?>
                </ul>
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        <?php if(Yii::$app->user->isGuest):?>
                            <li><a href="<?= Url::toRoute(['/login'])?>">Login</a></li>
                            <li><a href="<?= Url::toRoute(['/signup'])?>">Register</a></li>
                        <?php else: ?>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; <? echo date('Y'); ?> <a href="#">Blogger, </a> Built with <i
                            class="fa fa-heart"></i> by <a href="#">Nick Poddubny</a>
                    </div>
                </div>
            </div>
        </div>
